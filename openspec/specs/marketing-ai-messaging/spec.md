...
Marketing copy presents Kychon's AI as platform-native and zero-setup, and advertises only the AI features that actually ship — content moderation and auto-translation.
...
The AI feature grid SHALL contain exactly two cards: Content Moderation and Auto-Translation. The generative features (Newsletter Writer, Smart Onboarding, Member Insights, Event Recaps) SHALL NOT appear.
...
### Requirement: Comparison table reflects available AI

The compare.html feature table SHALL show AI moderation and AI translation as available (checkmark) and SHALL NOT carry an AI newsletter row.
...
### Requirement: Niche pages describe AI as built-in
