...
Each niche landing page SHALL follow a consistent layout: niche-specific hero (headline, subheading tailored to the audience), key features relevant to that niche, a showcase link (if a showcase site exists for that niche), a pricing section (shared with main page), and a CTA. Pages SHALL reuse the marketing CSS.

#### Scenario: Niche page structure
- **WHEN** a visitor loads any niche page
- **THEN** the page SHALL display a niche hero, niche features, showcase link (or "coming soon"), pricing, and CTA

### Requirement: Church niche page
