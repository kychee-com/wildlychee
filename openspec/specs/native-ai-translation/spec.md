...
Content translation runs on Run402's platform-native `ai.translate()` helper, so portal operators supply no AI provider key and quota is tracked by the platform.
