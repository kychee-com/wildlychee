...
Kychon's core template is built (Phases 1-2), but non-technical community managers can't deploy it without developer help. Phase 3 turns Kychon into a standalone product by adding Kychon Studio — an AI builder that investigates, interviews, and deploys a portal in 5 minutes — plus a marketing site that positions Kychon against overpriced incumbents (Wild Apricot $530/mo, Circle $89/mo + fees) with a $5-20/mo flat-fee message.

## What Changes

- **Kychon Studio skill**: A Claude Code skill (`/kychon-studio`) that orchestrates the full setup flow — Chrome-based website investigation, context-aware interview, spec generation, automated build + deploy, and Chrome verification
...
- **Marketing landing page**: `kychon.com` homepage with competitive positioning, pricing table, AI feature showcase, and niche audience cards
...
### New Capabilities
- `kychon-studio`: AI-powered portal builder — website investigation via Chrome MCP, smart interview flow, spec/config generation, automated build + deploy + verification
...
- `marketing-site`: Landing page and niche pages for kychon.com — competitive positioning, pricing, CTA flows
...
- **New files**: `/kychon-studio/` skill directory, `functions/generate-newsletter.js`, `functions/generate-recap.js`, marketing site HTML/CSS/JS, niche seed SQL files
...
- **External**: `kychon.com` domain (already on Route53), Run402 hosting for marketing site
