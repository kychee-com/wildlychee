...
The system SHALL display announcements on the home page and/or a dedicated announcements section. Pinned announcements SHALL appear first. Announcements SHALL be ordered by `created_at` descending.
